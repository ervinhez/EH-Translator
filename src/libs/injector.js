...
export const injectInlineJs = (code, id = "eh-translator-inline-js") => {
  // 避免重复注入相同 ID 的脚本
  ...
  el.setAttribute("data-source", "eh-inject injectInlineJs");
...
export const injectInlineJsBg = (code, id = "eh-translator-inline-js") => {
  if (document.getElementById(id)) {
    return;
  }

  const el = document.createElement("script");
  el.setAttribute("data-source", "eh-inject injectInlineJsBg");
  el.type = "text/javascript";
  el.id = id;
  el.textContent = code;
...
export const injectExternalJs = (src, id = "eh-translator-external-js") => {
  if (document.getElementById(id)) {
    return;
  }

  const el = document.createElement("script");
  el.setAttribute("data-source", "eh-inject injectExternalJs");
  el.type = "text/javascript";
  el.id = id;
...
export const injectInternalCss = (styles) => {
  ...
  el.setAttribute("data-source", "eh-inject injectInternalCss");
...
export const injectExternalCss = (href) => {
  ...
  el.setAttribute("data-source", "eh-inject injectExternalCss");
