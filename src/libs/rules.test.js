...
import { OPT_TRANS_DEEPSEEK, OPT_TRANS_TENCENT } from "../config/api";
...
test("uses DeepSeek as the default webpage translator", () => {
  expect(GLOBLA_RULE.apiSlug).toBe(OPT_TRANS_DEEPSEEK);
});
