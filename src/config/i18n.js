...
export const I18N = {
  ...
  page_translation_defaults: {
    ...
    ja: `ウェブページ翻訳のデフォルト設定`,
    ko: `웹페이지 번역 기본 설정`,
    tr: `Web sayfası çeviri varsayılanları`,
    vi: "Cài đặt dịch trang web mặc định",
  },
  apis_setting: {
    zh: `接口设置`,
    en: `Apis Setting`,
  ...
  sync_warn: {
    ...
    tr: `Gizlilikle ilgili verileri senkronize ederken, üçüncü taraf senkronizasyon hizmetlerini seçerken lütfen dikkatli olun. EH-Worker veya WebDAV kullanarak kendi senkronizasyon hizmetinizi kurmanız önerilir`,
  ...
  about_sync_api: {
    ...
    tr: `EH-Worker Veri Senkronizasyon Hizmetini Kendi Kendine Barındırma`,
  ...
  error_sync_setting: {
    zh: `您的同步类型必须为“EH-Worker”，且需填写完整`,
    en: `Your sync type must be "EH-Worker" and must be filled in completely`,
    zh_TW: `您的同步型態必須為「EH-Worker」，且需填寫完整。`,
    ja: `同期タイプは「EH-Worker」である必要があり、すべて入力する必要があります。`,
    ko: `동기화 유형은 "EH-Worker"여야 하며, 모든 항목을 빠짐없이 입력해야 합니다.`,
    tr: `Senkronizasyon Türünüz "EH-Worker" Olmalı Ve Eksiksiz Olarak Doldurulmalıdır`,
    vi: 'Your sync type must be "EH-Worker" and must be filled in completely',
  },
  click_test: {
    zh: `点击测试`,
    en: `Click Test`,
  ...
  selected_translation_alert: {
    zh: `划词翻译的开启和关闭请到“基本设置”里面设置。`,
    en: `To turn selected translation on or off, please go to "Basic Setting".`,
    zh_TW: `選取文字翻譯的開啟和關閉請到「基本設定」裡面設定。`,
    ja: `選択翻訳のオン/オフは「基本設定」で行ってください。`,
    ko: `선택 번역 활성화/비활성화는 "기본 설정"에서 하십시오.`,
    tr: `Seçilen çeviri özelliğini açmak veya kapatmak için lütfen "Basit Ayar"a gidin.`,
    vi: 'To turn selected translation on or off, please go to "Basic Setting".',
  },
  mousehover_key_help: {
